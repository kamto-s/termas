        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <select name="pendidikan" class="form-control">
                    ...
                    <option value="TIDAK/BELUM SEKOLAH" <?= set_select('pendidikan','TIDAK/BELUM SEKOLAH'); ?>>TIDAK/BELUM SEKOLAH</option>
                    <option value="BELUM TAMAT SD/SEDERAJAT" <?= set_select('pendidikan','BELUM TAMAT SD/SEDERAJAT'); ?>>BELUM TAMAT SD/SEDERAJAT</option>
                    <option value="TAMAT SD/SEDERAJAT" <?= set_select('pendidikan','TAMAT SD/SEDERAJAT'); ?>>TAMAT SD/SEDERAJAT</option>
                    <option value="SLTP/SEDERAJAT" <?= set_select('pendidikan','SLTP/SEDERAJAT'); ?>>SLTP/SEDERAJAT</option>
                    <option value="SLTA/SEDERAJAT" <?= set_select('pendidikan','SLTA/SEDERAJAT'); ?>>SLTA/SEDERAJAT</option>
                    ...
                    <option value="DIPLOMA IV/SARJANA" <?= set_select('pendidikan','DIPLOMA IV/SARJANA'); ?>>DIPLOMA IV/SARJANA</option>
                    <option value="MAGISTER" <?= set_select('pendidikan','MAGISTER'); ?>>MAGISTER</option>
                    <option value="DOKTOR" <?= set_select('pendidikan','DOKTOR'); ?>>DOKTOR</option>
                </select>
            ...
            <div class="col-md-6 mb-3">
                ...
                <select name="status_perkawinan" class="form-control">
                    <option value="">-- Pilih --</option>
                    <option value="BELUM KAWIN" <?= set_select('status_perkawinan','BELUM KAWIN'); ?>>BELUM KAWIN</option>
                    <option value="KAWIN" <?= set_select('status_perkawinan','KAWIN'); ?>>KAWIN</option>
                    <option value="CERAI HIDUP" <?= set_select('status_perkawinan','CERAI HIDUP'); ?>>CERAI HIDUP</option>
                    <option value="CERAI MATI" <?= set_select('status_perkawinan','CERAI MATI'); ?>>CERAI MATI</option>
                </select>
            ...
            <select name="dusun" class="form-control">
                ...
                <option value="MRAYUN" <?= set_select('dusun', 'MRAYUN'); ?>>Mrayun</option>
                <option value="TERMAS" <?= set_select('dusun', 'TERMAS'); ?>>Termas</option>
                <option value="GETAS" <?= set_select('dusun', 'GETAS'); ?>>Getas</option>
            </select>
            </div>
