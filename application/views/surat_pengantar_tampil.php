<div class="container">
    ...
    <h5>Permohonan Surat Pengantar</h5>
    ...
    <table class="table table-bordered table-striped" id="tabelku">
        ...
        <?php foreach($surat_pengantar as $k => $v){ ?>
            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <?php if($v['status']=="Disetujui"){ ?>
                        ...
                        <a href="<?= base_url('surat_pengantar/print/'.$v['id_surat_pengantar']); ?>"
    ...
    <a href="<?= base_url('surat_pengantar/tambah'); ?>" class="btn btn-primary">
